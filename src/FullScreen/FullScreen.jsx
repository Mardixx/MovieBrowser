...
export const FullScreen = (Infos) => {  
    ...
    return (
        <div className='infosForPage'>
            <img className="backdropFullPage" src={`https://image.tmdb.org/t/p/original/${ infos.backdrop_path }`} width="100%" />
            ...
            <div className="allInfos">
                ...
                <span className="releaseDate">Release Date: { infos.release_date}</span>
